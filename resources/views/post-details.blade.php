				...
				<div class="col-lg-12 p-0">
					<div class="hero-nav-area">
						...
						<p class="text-white link-nav">
							...
							<a href="post-details.html">News Details</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-9 posts-list">
					<div class="single-post-blog row">
						...
						<div class="col-lg-12">
							<h1 class="mt-20 mb-20">Cartridge Is Better Than Ever <br>
								A Discount Toner</h1>

							<div class="row tags">
								<div class="col-lg-6 col-md-6 col-sm-6">
									<div>
										<a href="#" class="primary-btn mr-10">Lifestyle</a>
										<a href="#" class="primary-btn">Gadget</a>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 text-right">
									<div class="d-flex justify-content-end">
										...
										<div>
											<img class="img-fluid" src="img/blog/s-img.jpg" alt="">
										</div>
									</div>
								</div>
							</div>
					...
					<div class="comment-form">
						...
						<form>
							...
							<a href="#" class="primary-btn fill">Post Comment</a>
						</form>
					</div>
				</div>

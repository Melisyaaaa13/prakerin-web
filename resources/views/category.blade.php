				...
				<div class="row align-items-center justify-content-between">
					...
					<nav id="nav-menu-container" class="mx-auto">
						<ul class="nav-menu">
							...
							<li class="menu-active"><a href="{{ url('category') }}">Category</a></li>
							<li class="menu-has-children"><a href="">Pages</a>
								<ul>
									<li><a href="{{ url('post-deails') }}">Post Details</a></li>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-5 col-sm-6">
								<div class="single-post single-int mb-40">
									<div class="thumb">
										<div class="relative">
											<img class="f-img img-fluid mx-auto" src="img/int-news/i3.jpg" alt="">
										</div>
									</div>
									<div class="">
										<div class="bottom mt-10">
					...
					<div class="row">
						<div class="col-lg-12 col-md-5 col-sm-6">
							<div class="single-post mb-20">
								<div class="thumb">
									<div class="relative">
										<img class="f-img img-fluid w-100" src="img/c1.jpg" alt="">
						...
						<div class="col-lg-12 col-md-5 col-sm-6">
							<div class="single-post">
								<div class="thumb">
									<div class="relative">
										<img class="f-img img-fluid w-100" src="img/c2.jpg" alt="">
										<div class="overlay overlay-bg"></div>
									</div>
								</div>
								<div class="details">

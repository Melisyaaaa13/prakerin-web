			...
			<div class="row">
					...
					<div class="row">
						<div class="col-lg-12 col-md-4 col-sm-6">
							<div class="single-post mb-03">
								<div class="thumb">
									<div class="relative">
										<img class="f-img img-fluid mx-auto" src="img/banner/lb1.jpg" alt="">
						...
						<div class="col-lg-12 col-md-4 col-sm-6">
							<div class="single-post mb-03">
								<div class="thumb">
									<div class="relative">
										<img class="f-img img-fluid mx-auto" src="img/banner/lb2.jpg" alt="">
										<div class="overlay overlay-bg"></div>
									</div>
								</div>
								<div class="details">
						...
						<div class="col-lg-12 col-md-4 col-sm-6">
							<div class="single-post">
								<div class="thumb">
									<div class="relative">
										<img class="f-img img-fluid mx-auto" src="img/banner/lb3.jpg" alt="">
										<div class="overlay overlay-bg"></div>
									</div>
								</div>
								<div class="details">
				...
				<div class="col-lg-6 col-md-8 owl-carousel active-banner">
					<div class="single-post">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/banner/bc1.jpg" alt="">
								<div class="overlay overlay-bg"></div>
							</div>
						</div>
						<div class="details">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-6">
							<div class="single-post mb-03">
								<div class="thumb">
									<div class="relative">
										<img class="f-img img-fluid mx-auto" src="img/banner/br2.jpg" alt="">
										<div class="overlay overlay-bg"></div>
									</div>
								</div>
								<div class="details">
						...
						<div class="col-lg-12 col-md-12 col-sm-6">
							<div class="single-post">
								<div class="thumb">
									<div class="relative">
										<img class="f-img img-fluid mx-auto" src="img/banner/br1.jpg" alt="">
										<div class="overlay overlay-bg"></div>
									</div>
								</div>
								<div class="details">
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6">
					<div class="single-post d-flex single-post2 mb-40">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/editors-pick/e1.jpg" alt="">
							</div>
						</div>
						<div class="">
							<div class="bottom">
				...
				<div class="col-lg-3 col-md-3 col-sm-6">
					<div class="single-post d-flex single-post2 mb-40">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/editors-pick/e2.jpg" alt="">
							</div>
						</div>
						<div class="">
							<div class="bottom">
				...
				<div class="col-lg-3 col-md-3 col-sm-6">
					<div class="single-post d-flex single-post2">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/editors-pick/e3.jpg" alt="">
							</div>
						</div>
						<div class="">
							<div class="bottom">
				...
				<div class="col-lg-3 col-md-3 col-sm-6">
					<div class="single-post d-flex single-post2">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/editors-pick/e4.jpg" alt="">
							</div>
						</div>
						<div class="">
							<div class="bottom">
			...
			<div class="row">
					...
					<div class="row">
						<div class="col-lg-7 col-md-8">
							<div class="single-post single-int mb-40">
								<div class="thumb">
									<div class="relative">
										<img class="f-img w-100 img-fluid mx-auto" src="img/int-news/i1.jpg" alt="">
									</div>
								</div>
								<div class="">
							...
							<div class="row">
								<div class="col-lg-12 col-md-6 col-sm-6">
									<div class="single-post single-int mb-40">
										<div class="thumb">
											<div class="relative">
												<img class="f-img w-100 img-fluid mx-auto" src="img/int-news/i2.jpg" alt="">
											</div>
										</div>
										<div class="">
								...
								<div class="col-lg-12 col-md-6 col-sm-6">
									<div class="single-post single-int mb-40">
										<div class="thumb">
											<div class="relative">
												<img class="f-img w-100 img-fluid mx-auto" src="img/int-news/i3.jpg" alt="">
											</div>
										</div>
										<div class="">
											<div class="bottom mt-10">
				...
				<div class="col-lg-4">
					<div class="ad-widget-wrap">
						<img src="img/ad-300-600.jpg" alt="">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-5 col-sm-6">
					<div class="single-post single-int mb-40">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/tech-news/t1.jpg" alt="">
							</div>
						</div>
						<div class="">
							<div class="bottom mt-10">
				...
				<div class="col-lg-3 col-md-5 col-sm-6">
					<div class="single-post single-int mb-40">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/tech-news/t2.jpg" alt="">
				...
				<div class="col-lg-3 col-md-5 col-sm-6">
					<div class="single-post single-int mb-40">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/tech-news/t3.jpg" alt="">
							</div>
						</div>
						<div class="">
							<div class="bottom mt-10">
				...
				<div class="col-lg-3 col-md-5 col-sm-6">
					<div class="single-post single-int mb-40">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/tech-news/t4.jpg" alt="">
								<a class="play-btn" href="https://www.youtube.com/watch?v=ARA0AxrnHdM">
									<img src="img/play-icon.png" class="vdo-btn" alt="">
								</a>
							</div>
			...
			<div class="row">
				<div class="col-lg-12 owl-carousel active-banner">
					<div class="single-post">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/exclusive-videos/e1.jpg" alt="">
								<div class="overlay overlay-bg"></div>
							</div>
						</div>
						<div class="details">
							...
							<a class="play-btn" href="https://www.youtube.com/watch?v=ARA0AxrnHdM">
								<img src="img/video-icon.jpg" class="mt-30" alt="">
							</a>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-post single-int mb-40">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/popular-news/p1.jpg" alt="">
							</div>
						</div>
						<div class="">
					...
					<div class="single-post single-int mb-40">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/popular-news/p2.jpg" alt="">
							</div>
						</div>
						<div class="">
							<div class="bottom mt-10 d-flex justify-content-between align-items-center flex-wrap">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-post single-int mb-40">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/popular-news/p3.jpg" alt="">
							</div>
						</div>
						<div class="">
							<div class="bottom mt-10">
					...
					<div class="single-post single-int mb-40">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/popular-news/p4.jpg" alt="">
							</div>
						</div>
						<div class="">
							<div class="bottom mt-10">
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="single-post single-int mb-40">
						<div class="thumb">
							<div class="relative">
								<img class="f-img img-fluid mx-auto" src="img/popular-news/p-vdo.jpg" alt="">
								<a class="play-btn" href="https://www.youtube.com/watch?v=ARA0AxrnHdM">
									<img src="img/play-icon.png" class="vdo-btn" alt="">
								</a>
							</div>
